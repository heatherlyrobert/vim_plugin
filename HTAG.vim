...
function! HTAG_syntax()
   ...
   syntax match htag_detail         '^[a-z][a-z]  [a-zA-Z][a-zA-Z0-9].*'
   syntax match htag_tag            '^[a-z][a-z]  '  containedin=rsh_tag_detail
   syntax match htag_separator      'o___[A-Z].*___' containedin=rsh_tab_detail
   ...
   hi htag_separator cterm=none           ctermbg=none   ctermfg=4
